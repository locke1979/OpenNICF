...
OPENNICF_EMBEDDING_REMOTE_ENABLED=false
OPENNICF_TEXT_EMBEDDING_MODEL=text-embedding-qwen3-embedding-4b
OPENNICF_VL_EMBEDDING_MODEL=qwen.qwen3-vl-embedding-2b
OPENNICF_EMBEDDING_DIMENSION=768
OPENNICF_EMBEDDING_NATIVE_DIMENSION=2560
OPENNICF_EMBEDDING_TIMEOUT=30
OPENNICF_EMBEDDING_SPACE_REVISION=production-http-v1
```
